...
const ALL_PROFESSIONS: Record<string, ProfessionPageData> = {
  ...
  author: {
    slug: "Author", heroBadge: "Author & Writer Headshots", heroTitle: "AI Headshots for Authors & Writers", heroHighlight: "Authors & Writers", heroDescription: "Build credibility on book jackets, author websites, press kits, and social media. Professional AI author headshots — 40+ HD from $29 in ~25 minutes.", featureList: ["Book Jacket Ready", "Author Website Approved", "Press & Media Polish"], whySection: { title: "Why Author Headshots Matter", cards: [{ title: "Reader Connection", desc: "A warm, professional photo on your book jacket and website helps readers feel connected before they open page one." }, { title: "Publisher Ready", desc: "Publishers and agents expect author photos for press kits, catalogs, and promotional materials." }, { title: "Brand Consistency", desc: "Use the same professional portrait across Amazon Author Page, Goodreads, and conference speaker bios." }] }, useCases: ["Book jacket and back cover", "Amazon Author Page and Goodreads", "Publisher press kits and media materials", "Conference and book festival speaker bios", "Social media and newsletter branding"], ctaHeadline: "Put Your Best Face on Your Book", ctaSubtext: "From $29 for 40+ author-quality headshots. Upload selfies and download publisher-ready photos in ~25 minutes.", faqs: [{ question: "How much do author headshots cost?", answer: `${STARTER_PRICE_LINE} Traditional author portrait sessions run $300–$800+.` }, { question: "How fast will I get them?", answer: DELIVERY_FAQ_ANSWER_40_PLUS }, { question: "Can I use AI headshots on my book jacket?", answer: "Yes. Self-published and traditionally published authors increasingly use AI headshots for digital and print book jackets." }, { question: "What background works best for author photos?", answer: "Neutral studio backgrounds (white, grey, or soft gradient) keep the focus on you. Outdoor bookish settings (libraries, cafes) also work for creative nonfiction and fiction authors." }], relatedPages: [{ label: "Portfolio Headshots", href: "/headshots/portfolio" }, { label: "Professional Headshots", href: "/headshots/professional" }, { label: "All Styles", href: "/headshots" }] },
  business: {
  ...
  engineer: {
    slug: "Engineer", heroBadge: "Engineering Professional Headshots", heroTitle: "AI Headshots for Engineers", heroHighlight: "Engineers", heroDescription: "Present a polished, competent image on company sites, GitHub, LinkedIn, and conference bios. Professional AI engineer headshots — 40+ HD from $29 in ~25 minutes.", featureList: ["Company Site Ready", "GitHub & LinkedIn Polish", "Conference Speaker Approved"], whySection: { title: "Why Engineer Headshots Matter", cards: [{ title: "Technical Credibility", desc: "A clean, professional photo signals competence and attention to detail before anyone reads your code." }, { title: "Team Presence", desc: "Stand out on your company's engineering team page and internal directories." }, { title: "Career Growth", desc: "A polished LinkedIn photo supports your advancement from IC to senior to staff engineer." }] }, useCases: ["Company engineering team page", "LinkedIn and GitHub profiles", "Conference and meetup speaker bios", "Internal wiki and Slack/Teams avatar", "Technical blog and portfolio site"], ctaHeadline: "Showcase Your Engineering Excellence", ctaSubtext: "From $29 for 40+ professional headshots. Upload selfies and download engineer-ready photos in ~25 minutes.", faqs: [{ question: "How much do engineer headshots cost?", answer: `${STARTER_PRICE_LINE} Traditional sessions run $200–$500.` }, { question: "How fast will I get them?", answer: DELIVERY_FAQ_ANSWER_40_PLUS }, { question: "Do engineers really need professional headshots?", answer: "Yes — your photo appears on company team pages, conference bios, LinkedIn, and GitHub. A polished portrait signals professionalism regardless of role." }, { question: "What outfit works best for an engineer headshot?", answer: "Business casual works well — button-down shirt or blazer without tie for tech; slightly more formal for traditional engineering fields. Match your company culture." }], relatedPages: [{ label: "Corporate Headshots", href: "/headshots/corporate" }, { label: "Startup Headshots", href: "/headshots/startup" }, { label: "All Styles", href: "/headshots" }] },
  finance: {
    slug: "Finance", heroBadge: "Finance Professional Headshots", heroTitle: "AI Headshots for Finance Professionals", heroHighlight: "Finance Professionals", heroDescription: "Build client trust with professional headshots for your firm website, LinkedIn, and investor materials. 40+ HD finance headshots from $29 in ~25 minutes.", featureList: ["Client-Trust Building", "Investor-Ready Polish", "Firm-Website Approved"], whySection: { title: "Why Finance Headshots Matter", cards: [{ title: "Trust Signal", desc: "In finance, credibility is currency. A sharp, professional portrait on your firm site and LinkedIn builds instant trust." }, { title: "Client Confidence", desc: "Clients research advisors before reaching out — your photo is often the first trust checkpoint." }, { title: "Firm Branding", desc: "Consistent partner and advisor headshots project institutional strength and attention to detail." }] }, useCases: ["Financial advisory firm team page", "LinkedIn and FINRA BrokerCheck", "Investor pitch decks and PPMs", "Conference and industry panel bios", "Client-facing email signatures"], ctaHeadline: "Build Trust at First Glance", ctaSubtext: "From $29 for 40+ finance-professional headshots. Upload selfies and download firm-ready photos in ~25 minutes.", faqs: [{ question: "How much do finance professional headshots cost?", answer: `${STARTER_PRICE_LINE} Traditional financial advisor portrait sessions run $300–$800+.` }, { question: "How fast will I get them?", answer: DELIVERY_FAQ_ANSWER_40_PLUS }, { question: "Can financial advisors use AI headshots?", answer: "Yes. Many independent RIAs, wealth managers, and financial planners use AI headshots for LinkedIn, firm websites, and digital marketing." }, { question: "What's the best outfit for a finance headshot?", answer: "Dark suit or blazer with conservative tie, white or light blue shirt. Keep jewelry minimal. A traditional, authoritative look works best." }], relatedPages: [{ label: "Executive Headshots", href: "/headshots/executive" }, { label: "Corporate Headshots", href: "/headshots/corporate" }, { label: "Business Headshots", href: "/headshots/business" }, { label: "All Styles", href: "/headshots" }] },
  marketing: {
    slug: "Marketing", heroBadge: "Marketing Professional Headshots", heroTitle: "AI Headshots for Marketers", heroHighlight: "Marketers", heroDescription: "Look sharp on agency sites, LinkedIn, client proposals, and conference bios. Professional AI marketing headshots — 40+ HD from $29 in ~25 minutes.", featureList: ["Agency & Client Ready", "Personal Brand Polish", "Conference Speaker Approved"], whySection: { title: "Why Marketing Headshots Matter", cards: [{ title: "Personal Brand", desc: "You market brands every day — your headshot is your own brand's first impression." }, { title: "Client Proposals", desc: "A polished photo on proposals and pitch decks signals creative and professional competence." }, { title: "Agency Presence", desc: "Stand out on your agency's team page and win client confidence before the first call." }] }, useCases: ["Agency team page and capabilities deck", "LinkedIn and personal branding", "Client proposals and pitch materials", "Conference and webinar speaker bios", "Email signature and social media"], ctaHeadline: "Market Yourself as Well as You Market Brands", ctaSubtext: "From $29 for 40+ professional headshots. Upload selfies and download marketing-ready photos in ~25 minutes.", faqs: [{ question: "How much do marketing headshots cost?", answer: `${STARTER_PRICE_LINE}` }, { question: "How fast will I get them?", answer: DELIVERY_FAQ_ANSWER_40_PLUS }, { question: "Can marketing teams get matching headshots?", answer: "Yes. Use the same preset for all team members for a consistent agency look." }, { question: "What outfit works best for marketing professionals?", answer: "Business casual to smart casual — blazer or stylish top that reflects your agency's creative culture. Slightly more polished than tech but less formal than finance." }], relatedPages: [{ label: "Corporate Headshots", href: "/headshots/corporate" }, { label: "Business Headshots", href: "/headshots/business" }, { label: "All Styles", href: "/headshots" }] },
  military: {
    slug: "Military", heroBadge: "Military & Veteran Headshots", heroTitle: "AI Headshots for Military Personnel & Veterans", heroHighlight: "Military Personnel & Veterans", heroDescription: "Present a polished, disciplined image for LinkedIn, civilian career transition, and official profiles. 40+ HD military headshots from $29 in ~25 minutes.", featureList: ["Service-Disciplined Polish", "Civilian Career Ready", "LinkedIn Transition Approved"], whySection: { title: "Why Military Headshots Matter", cards: [{ title: "Civilian Transition", desc: "A professional civilian headshot is essential when transitioning from military service to the private sector." }, { title: "Leadership Signal", desc: "Your military bearing transfers to civilian roles — a polished portrait amplifies that signal." }, { title: "Veteran Network", desc: "Stand out on LinkedIn and veteran professional networks with a headshot that opens doors." }] }, useCases: ["LinkedIn and civilian job applications", "Veteran networking platforms", "Company leadership and team pages", "Security clearance and contractor portals", "Conference and speaking bios"], ctaHeadline: "Transition with Confidence", ctaSubtext: "From $29 for 40+ professional headshots. Upload selfies and download civilian-career-ready photos in ~25 minutes.", faqs: [{ question: "How much do military transition headshots cost?", answer: `${STARTER_PRICE_LINE}` }, { question: "Should I use a uniform or civilian photo?", answer: "For civilian job searches, a professional civilian headshot performs better on LinkedIn and corporate applications. Keep uniform photos for military-specific roles and veteran networks." }, { question: "How fast will I get them?", answer: DELIVERY_FAQ_ANSWER_40_PLUS }], relatedPages: [{ label: "Professional Headshots", href: "/headshots/professional" }, { label: "Corporate Headshots", href: "/headshots/corporate" }, { label: "LinkedIn Headshots", href: "/headshots/linkedin" }, { label: "All Styles", href: "/headshots" }] },
  model: {
    slug: "Model", heroBadge: "Model & Talent Headshots", heroTitle: "AI Headshots for Models & Talent", heroHighlight: "Models & Talent", heroDescription: "AI model headshots for comp cards, agency submissions, and portfolios. Multiple looks in ~25 minutes. 40+ HD photos from $29.", featureList: ["Multiple Agency Looks", "Comp Card Ready", "Portfolio Variety"], whySection: { title: "Why Model Headshots Matter", cards: [{ title: "Agency Submissions", desc: "Agencies scan hundreds of submissions — a clean, professional headshot gets yours noticed." }, { title: "Versatile Portfolio", desc: "Show range with multiple outfits, backgrounds, and expressions in one AI batch." }, { title: "Fast Updates", desc: "New haircut? New look? Refresh your entire portfolio in ~25 minutes." }] }, useCases: ["Model agency and casting submissions", "Comp cards and look books", "Instagram and social media branding", "Personal portfolio website", "Commercial and print booking packages"], ctaHeadline: "Get Agency-Ready Headshots Now", ctaSubtext: "From $29 for 40+ model-quality headshots. Multiple looks, one upload, ~25 minutes.", faqs: [{ question: "How much do model headshots cost?", answer: `${STARTER_PRICE_LINE} Traditional agency sessions with multiple looks run $500–$1,500+.` }, { question: "Can I get multiple looks in one batch?", answer: "Yes. Each AI batch generates multiple outfits, backgrounds, and expressions — giving agencies a range of looks from one session." }, { question: "Are AI headshots accepted by modeling agencies?", answer: "Many commercial and lifestyle agencies accept AI headshots for initial digital submissions. High-fashion editorial agencies may still require in-person tests. Always check specific agency requirements." }, { question: "How fast?", answer: DELIVERY_FAQ_ANSWER_40_PLUS }], relatedPages: [{ label: "Portfolio Headshots", href: "/headshots/portfolio" }, { label: "Actor Headshots", href: "/headshots/actor" }, { label: "All Styles", href: "/headshots" }] },
  nurse: {
  ...
  "remote-worker": {
    slug: "Remote Worker", heroBadge: "Remote Work Professional Headshots", heroTitle: "AI Headshots for Remote Workers", heroHighlight: "Remote Workers", heroDescription: "Look credible on Zoom, Slack, LinkedIn, and your personal website. Professional AI remote worker headshots — 40+ HD from $29 in ~25 minutes.", featureList: ["Zoom & Slack Ready", "LinkedIn-Approved Polish", "Remote-First Branding"], whySection: { title: "Why Remote Worker Headshots Matter", cards: [{ title: "Video Call Presence", desc: "A professional photo as your virtual background or profile picture builds credibility on every call." }, { title: "Digital-First Branding", desc: "As a remote worker, your online image IS your in-person impression. Make it count." }, { title: "Distributed Team Trust", desc: "A polished profile photo helps colleagues across time zones feel connected to the person behind the screen." }] }, useCases: ["Zoom, Slack, Teams, and Google Meet avatars", "LinkedIn and remote job applications", "Personal website and portfolio", "Email signature and digital business card", "Distributed team directory and org chart"], ctaHeadline: "Look Professional from Anywhere", ctaSubtext: "From $29 for 40+ professional headshots. Upload selfies and download remote-work-ready photos in ~25 minutes.", faqs: [{ question: "How much do remote worker headshots cost?", answer: `${STARTER_PRICE_LINE}` }, { question: "How fast will I get them?", answer: DELIVERY_FAQ_ANSWER_40_PLUS }, { question: "What outfit works for remote work headshots?", answer: "Smart casual to business casual — a clean button-down or nice top that looks good on video. Avoid distracting patterns that pixelate on camera." }, { question: "Should remote workers have different photos for different platforms?", answer: "You can generate a batch with multiple expressions — one polished for LinkedIn, one warmer for Slack, and one neutral for company directories." }], relatedPages: [{ label: "Professional Headshots", href: "/headshots/professional" }, { label: "LinkedIn Headshots", href: "/headshots/linkedin" }, { label: "Business Headshots", href: "/headshots/business" }, { label: "All Styles", href: "/headshots" }] },
  sales: {
    slug: "Sales", heroBadge: "Sales Professional Headshots", heroTitle: "AI Headshots for Sales Professionals", heroHighlight: "Sales Professionals", heroDescription: "Build instant trust on LinkedIn, email signatures, and company pages. Professional AI sales headshots — 40+ HD from $29 in ~25 minutes.", featureList: ["Trust-Building Polish", "Email & LinkedIn Ready", "Prospect-Facing Quality"], whySection: { title: "Why Sales Headshots Matter", cards: [{ title: "First Trust Signal", desc: "Prospects research you before taking a call — your photo is the first trust checkpoint in your outreach." }, { title: "Response Rates", desc: "Emails and InMails with professional photos see higher open and response rates." }, { title: "Personal Brand", desc: "In modern sales, you are the brand. A polished portrait supports every touchpoint in your pipeline." }] }, useCases: ["LinkedIn profile and Sales Navigator", "Email signature and outreach campaigns", "Company website team page", "Conference and trade show speaker bios", "Digital business cards"], ctaHeadline: "Close More Deals with a Professional Image", ctaSubtext: "From $29 for 40+ sales-ready headshots. Upload selfies and download prospect-facing photos in ~25 minutes.", faqs: [{ question: "How much do sales professional headshots cost?", answer: `${STARTER_PRICE_LINE}` }, { question: "How fast will I get them?", answer: DELIVERY_FAQ_ANSWER_40_PLUS }, { question: "Do professional headshots really help in sales?", answer: "Absolutely. LinkedIn profiles with professional photos receive significantly more connection requests and InMail responses. In sales, trust starts before the first word." }, { question: "Can my entire sales team get matching headshots?", answer: "Yes. Create a consistent team look with the same preset — every rep projects the same professional brand." }], relatedPages: [{ label: "Business Headshots", href: "/headshots/business" }, { label: "LinkedIn Headshots", href: "/headshots/linkedin" }, { label: "Corporate Headshots", href: "/headshots/corporate" }, { label: "All Styles", href: "/headshots" }] },
  startup: {
  ...
  student: {
    slug: "Student", heroBadge: "Student & Graduate Headshots", heroTitle: "AI Headshots for Students & Recent Graduates", heroHighlight: "Students & Graduates", heroDescription: "Stand out on LinkedIn, internship applications, and university profiles. Professional AI student headshots — 40+ HD from $29 in ~25 minutes.", featureList: ["Internship-Ready Polish", "LinkedIn Approved", "Grad School Application Quality"], whySection: { title: "Why Student Headshots Matter", cards: [{ title: "First Job Edge", desc: "Recruiters scan hundreds of student profiles — a professional photo makes yours stand out instantly." }, { title: "Internship Success", desc: "A polished headshot on applications and LinkedIn signals maturity and professionalism before the interview." }, { title: "Grad School Ready", desc: "Applications, faculty bios, and conference presentations all benefit from a professional portrait." }] }, useCases: ["LinkedIn profile and job applications", "Internship and co-op applications", "University and alumni directories", "Graduate school applications", "Student organization leadership profiles"], ctaHeadline: "Launch Your Career with Confidence", ctaSubtext: "From $29 for 40+ professional headshots. Upload selfies and download career-launching photos in ~25 minutes.", faqs: [{ question: "How much do student headshots cost?", answer: `${STARTER_PRICE_LINE}` }, { question: "How fast will I get them?", answer: DELIVERY_FAQ_ANSWER_40_PLUS }, { question: "Do students really need professional headshots?", answer: "Yes. Your LinkedIn photo is often the first thing recruiters see. A professional headshot increases profile views and connection requests significantly — giving you an edge in competitive job markets." }, { question: "What should I wear for my student headshot?", answer: "Business casual — a blazer, button-down, or professional top that matches your target industry. Skip the graduation gown unless specifically for university directory use." }], relatedPages: [{ label: "LinkedIn Headshots", href: "/headshots/linkedin" }, { label: "Professional Headshots", href: "/headshots/professional" }, { label: "All Styles", href: "/headshots" }] },
  teacher: {
