      ...
      <div className="container px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center mb-8">
          ...
          <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl mb-6">
            The #1 AI Headshot Generator for <span className="text-primary">Professionals</span>
          </h1>
          <p className="text-muted-foreground text-lg md:text-xl max-w-[800px] mx-auto">
            Turn your selfies into studio-quality professional headshots in 30 minutes. Save <strong>$200-$500</strong> compared to traditional photography.
          </p>
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-6 text-sm text-muted-foreground">
            <span className="flex items-center gap-1">
              ...
              <strong className="text-foreground">4.8/5</strong> from 2,000+ reviews
            </span>
            <span className="flex items-center gap-1">
