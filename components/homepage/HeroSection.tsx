      ...
      <div className="container px-4 md:px-6 pt-2">
        <div className="mx-auto max-w-3xl text-center mb-8">
          ...
          <p className="text-muted-foreground text-lg md:text-xl max-w-[800px] mx-auto">
            Professional enough for LinkedIn. Natural enough to still be you. 8x cheaper than a $232 photoshoot.
          </p>
          ...
          <p className="mt-3 text-sm text-muted-foreground flex items-center justify-center gap-1 flex-wrap">
            ...
            ★★★★★ <span className="font-semibold text-foreground">50,000+</span> headshots delivered · 🛡️ Privacy first
          </p>
        </div>
