...
export const metadata: Metadata = {
  title: "AI Headshot Examples & Reviews | SnapProHead",
  description:
    "Preview studio-quality AI headshots and read typical feedback from professionals updating LinkedIn and work profiles.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Preview studio-quality AI headshots and read typical feedback from professionals updating LinkedIn and work profiles.",
    url: "https://snapprohead.com/examples",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "SnapProHead AI Headshot Examples",
      },
    ],
  },
  twitter: {
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center gap-3 sm:gap-4 text-center">
              ...
              <div className="mt-4 flex flex-col items-center gap-2">
                ...
                <p className="max-w-[560px] text-sm text-muted-foreground px-2">
                  {EXAMPLES_TESTIMONIALS_LEDE}
                </p>
              </div>
            </div>
