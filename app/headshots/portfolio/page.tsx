...
export const metadata: Metadata = {
  title: 'Portfolio Headshots - Professional AI Photos for creatives',
  description: 'Get professional AI models and talents in ~30 minutes. Portfolio Headshots for creatives. 40+ HD photos, starting at $29. 14-day money-back guarantee.',
  openGraph: {
    title: 'AI Portfolio Headshots - creatives',
    description: 'Professional models and talents for creatives. Starting at $29 for 40+ HD headshots.',
  },
}

export default function PortfolioHeadshotsPage() {
  return (
    <div className="container px-4 md:px-6 py-16 md:py-24">
      <div className="mx-auto max-w-3xl text-center mb-16">
        ...
        <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl mb-6">
          AI Headshots for <span className="text-primary">creatives</span>
        </h1>
        <p className="text-muted-foreground text-lg md:text-xl max-w-[800px] mx-auto mb-8">
          Professional models and talents that help you make the right impression. 
          Upload selfies and get studio-quality photos in ~30 minutes.
        </p>
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <Link href="/login">
            <Button size="lg" className="group w-full sm:w-auto">
              Create Your Portfolio Headshots
      ...
      <div className="mx-auto max-w-2xl mb-16 p-8 rounded-xl border bg-card">
        <h2 className="text-2xl font-bold mb-4">Professional Portfolio Headshots</h2>
        <p className="text-muted-foreground mb-4">
          Choose from 12 professional styles including portfolio looks, 
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <Link href="/login"><Button size="lg">Create Your Portfolio Headshots Now</Button></Link>
      ...
      <script type="application/ld+json"
        dangerouslySetInnerHTML={{__html: JSON.stringify({
          ...
          mainEntity: [
            {'@type':'Question', name: 'How much do models and talents cost?',
