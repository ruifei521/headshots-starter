...
export const metadata: Metadata = {
  ...
  description: 'Get professional AI professional in ~30 minutes. Professional Headshots for job seekers and career professionals. 40+ HD photos, just $29. 14-day money-back guarantee.',
  openGraph: {
    title: 'AI Professional Headshots - job seekers and career professionals',
    description: 'Professional professional for job seekers and career professionals. Just $29 for 40+ HD headshots.',
  },
}
    ...
    <div className="container px-4 md:px-6 py-16 md:py-24">
      <div className="mx-auto max-w-3xl text-center mb-16">
        ...
        <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl mb-6">
          AI Headshots for <span className="text-primary">job seekers and career professionals</span>
        </h1>
