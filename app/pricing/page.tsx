...
import { META_PRICING_DESCRIPTION, PRICING_TRUST_LINE } from "@/lib/refund-policy";
...
export const metadata: Metadata = {
  ...
  title: "Pricing — AI Professional Headshots from $29",

  description: META_PRICING_DESCRIPTION,

  alternates: {

    canonical: "https://snapprohead.com/pricing",
  ...
  return (
    ...
    <div className="bg-background min-h-[70vh]">
      ...
      <section className="py-8 md:py-14 border-b">
        ...
        <div className="container px-4 md:px-6 max-w-4xl mx-auto text-center space-y-3 sm:space-y-4">
          ...
          <p className="text-muted-foreground text-base max-w-lg mx-auto">
            ...
            Studio-quality AI portraits from your selfies. If you&apos;re not

            happy with usable results,{" "}
      ...
      <section
        ...
        className="py-10 md:py-14 bg-muted/20 scroll-mt-16"
